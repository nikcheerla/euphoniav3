...
for iteration in range(1, 1000):
	...
	length = 50000
	start_index = random.randint(0, data_len - length - 1)
	...
	model.save_weights("cur_net_weights.h5", overwrite = True)
	...
	for diversity in [0.2, 0.5, 0.75, 1.0, 1.2]:
		...
		track.append(eot)
		midi.write_midifile("net_example" + str(diversity) + ".mid", pattern)
